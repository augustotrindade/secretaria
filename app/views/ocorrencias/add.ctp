...
<?php echo $form->input('id'); ?>
			...
			<input type="submit" value="Salvar"> <input type="button" value="Voltar" onclick="javascript:window.location.href='<?php echo $html->url(array('controller'=>'ocorrencias','action'=>'index','id'=>$membro['Membro']['id'])) ?>'">
		</tr>
	</table>
<?php echo $form->end();?>
</div>
